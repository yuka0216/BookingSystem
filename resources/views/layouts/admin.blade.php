        ...
        <nav class="navbar navbar-expand-md navbar-dark bg-secondary shadow-sm">
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                    <div class="nabbar-nab">
                        <a class=btn btn-primary href="/admin/schedule">配送予定</a>
                        <a class=btn btn-primary href="/admin/carIndex">車両一覧</a>
                        <a class=btn btn-primary href="/admin/report">報告一覧</a>
                    </div>
                </div>
